    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 text-foreground hover:bg-accent hover:text-accent-foreground"
        ),
        ...
        day_outside: "text-muted-foreground opacity-50 cursor-not-allowed",
